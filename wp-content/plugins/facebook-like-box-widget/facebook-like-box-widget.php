	...
	*/
	function widget($args, $instance){
		...
		$renderedHTML = "	<div id='fb-root'></div>
										...
										<div class='fb-like-box' data-href='".$pageURL."' data-width='".$width."' data-height='".$height."' data-show-faces='".$showFaces."' data-stream='".$streams."' data-show-border='false' data-header='".$header."'></div>
										";
