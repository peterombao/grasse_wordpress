...
<html>
    ...
    <body>
        <?php
            ...
            //print_r($asd);
        ?>
        <form action="converted_products.php" method="post">
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td><label>attribute:pa_size-g</label></td>
                        <td>
                            <select name="attribute_pa_size-g">
                                <option value=""></option>
                            <?php
                                for($i=0;$i<$num;$i++){
                            ?>
                    ...
                    <tr>
                        <td><label>attribute:pa_fragrance-type</label></td>
                        <td>
                            <select name="attribute_pa_fragrance-type">
                                <option value=""></option>
                            <?php
                                for($i=0;$i<$num;$i++){
                            ?>
